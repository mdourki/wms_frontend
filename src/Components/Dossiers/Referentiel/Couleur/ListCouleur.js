...
export default class ListCouleur extends Component {
  ...
  deleteCouleurFromDB() {
      ...
      .then(response => { 
        if(response.data == "Impossible de supprimer cette couleur, car elle est associée à un produit")
        {
            this.setState({
        ...
        <div className='content'>
            ...
            >
                ...
                <DialogContentText id="alert-dialog-description">
                    Etes-vous sûrs de vouloir supprimer la couleur {this.state.couleurCodeDel} ?
                </DialogContentText>
                </DialogContent>
                <DialogActions>

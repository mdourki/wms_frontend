...
export default function NewEmplacement() {
    ...
    const [alleeEmplacement,setAlleeEmplacement] = useState('')
    const [nivHorizEmplacement,setNivHorizEmplacement] = useState('')
    const [nivVertiEmplacement,setNivVertiEmplacement] = useState('')
    ...
    const saveEmplacement = () => {
      axios.post('http://localhost:8080/emplacements/save/'+alleeEmplacement+

...
export default class ListCollections extends Component {
    ...
    deleteCollectionFromDB() {
        ...
        .then(response => { 
            if(response.data == "Impossible de supprimer cette collection, car elle est associée à un produit")
            {
                this.setState({
        ...
        <div className='content'>
            ...
            >
                ...
                <DialogContentText id="alert-dialog-description">
                    Etes-vous sûrs de vouloir supprimer la collection {this.state.collectionDel} ?
                </DialogContentText>
                </DialogContent>
                <DialogActions>

...
export default function EditCategorieClient() {
    ...
    axios.get(`http://localhost:8080/listCatClt/getID/${categorie}`)
    ...
    const handleClick=(e)=>{
        e.preventDefault()
        axios.put('http://localhost:8080/listCatClt/update/'+categorieID+'/'+cltCategorieName , {
        })
        .then(res => {
            console.log(res);

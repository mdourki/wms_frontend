...
export default function FactureCltToPDF() {
    ...
    const downloadPDF=()=> {
        ...
        .then((canvas) => {
            ...
            pdf.save("livraison.pdf");
        })
    }

    const getFactureInfo=()=> {
        axios.get(`http://localhost:8080/factureCltInfo/${ligneFactureID}`)
  ...
  return (
    <div className='factureContent'>
        ...
        <div id="divToPrint">
            <p className='title'>Bon de livraison</p>
            <TableContainer component={Paper} className="tableFacture">
                <Table sx={{ minWidth: 600 }} aria-label="customized table">
                    <TableBody>
                        ...
                        <TableRow>
                            <TableCell style={headStyle}><b>Client</b></TableCell>
